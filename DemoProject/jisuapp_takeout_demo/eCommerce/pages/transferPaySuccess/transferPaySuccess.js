...
Page({
  ...
  scratchInit: function () {
    ...
    that.scratch = new Scratch(that, {
      canvasWidth: width,
      canvasHeight: height,
      imageResource: 'http://www.zhichiwangluo.com/static/webapp/images/scratchMovie.png',
      maskColor: "red",
      r: 18,
      callback: () => {
        that.setData({
  ...
  goToWheelDetail: function () {
    app.turnToPage('/awardManagement/pages/luckyWheelDetail/luckyWheelDetail', 1);
  },
  // 跳转到砸金蛋
  goToGoldenEggs: function () {
    app.turnToPage('/awardManagement/pages/goldenEggs/goldenEggs', 1);
  },
  // 刮刮乐的触摸事件
