...
Page({
  ...
  goToHomepage: function(){
    ...
    if (that.data.franchiseeId){
      ...
      if (p.route == 'franchisee/pages/goodsMore/goodsMore'){
    ...
    if(goods.model_items.length){
      ...
      if(goods.is_seckill == 1){ //假如是秒杀
        ...
        for (let i = 0; i < items.length; i++) {
          ...
          selectVirtualPrice = selectVirtualPrice ? (selectVirtualPrice > virtualPrice ? selectVirtualPrice : virtualPrice) : virtualPrice;
