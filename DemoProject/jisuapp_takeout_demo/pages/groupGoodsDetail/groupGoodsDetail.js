...
Page({
  ...
  onShareAppMessage: function () {
    var that = this,
        ...
        url = '/pages/groupGoodsDetail/groupGoodsDetail?detail=' + goodsId + '&contact=' + contact + (franchiseeId ? '&franchisee=' + franchiseeId  : ''),
        title = app.getUserInfo('nickname') + ' 喊你拼单啦~ ' + this.data.goodsInfo.group_buy_info.group_buy_min_price + '元拼' + this.data.goodsInfo.title + '，火爆抢购中......';
