...
var _createClass = function() {
    ...
    locationProcess: function(t, e, i, o) {
        ...
        }, t.location ? r.checkLocation(t) && e(Utils.getLocationParam(t.location)) : r.getWXLocation(e, i, o);
    }
}, QQMapWX = function() {
    function t(e) {
    ...
    return _createClass(t, [ {
        ...
        value: function(t) {
            ...
            if (t = t || {}, Utils.polyfillParam(t), Utils.checkKeyword(t)) {
                ...
                Utils.locationProcess(t, function(e) {
                    i.boundary = "nearby(" + e.latitude + "," + e.longitude + "," + o + "," + r + ")", 
        ...
        value: function(t) {
            ...
            if (t = t || {}, Utils.polyfillParam(t), !Utils.checkParamKeyEmpty(t, "to")) {
                ...
                t.from && (t.location = t.from), Utils.locationProcess(t, function(e) {
