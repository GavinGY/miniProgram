...
Page({
    ...
    reLoad: function() {
        var t = this, e = wx.getStorageSync("sjdsjid");
    ...
    formSubmit1: function(t) {
        ...
        var e = this;
        if (t.detail.value.sfxs) a = 1; else var a = 2;
        var o = wx.getStorageSync("sjdsjid"), i = t.detail.value.flmc, s = t.detail.value.pxxh;
        console.log("", o, i, s, a);
        var n = "", l = !0;
    ...
    formSubmit: function(t) {
        ...
        var e = this, a = this.data.activeid;
        if (t.detail.value.sfxs) o = 1; else var o = 2;
        var i = wx.getStorageSync("sjdsjid"), s = t.detail.value.flmc, n = t.detail.value.pxxh;
