...
Page({
    ...
    formSubmit: function(e) {
        ...
        if (console.log(o), 0 == o.length) c = n; else if (Number(n) >= Number(this.data.czhd[o.length - 1].full)) {
            var i = this.jsmj(n, o);
            console.log(i);
            c = Number(n) + Number(o[i].reduction);
        } else var c = n;
        console.log(a, n, s, c), app.util.request({
