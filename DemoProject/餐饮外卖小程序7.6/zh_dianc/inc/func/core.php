        ...
        if($_W['isfounder'] || $_W['role'] == 'manager' || $_W['role'] == 'operator') {
            ...
            $navemenu[4] = array(
                ...
                'items' => array(
                     ...
                     7 => $this->createMainMenu('自动接单 ', $do, 'laoz', ''),
                     8 => $this->createMainMenu('门店媒体 ', $do, 'mt', '')
                )
            );
            $navemenu[5] = array(
   ...
   public function getNaveMenu($storeid, $action)
    {
        ...
        $navemenu[4] = array(
            ...
            'items' => array(
                ...
                7 => $this->createSubMenu('自动接单 ', $do, 'dllaoz','fa-angle-right', $cur_color, $storeid),
                8 => $this->createSubMenu('门店媒体 ', $do, 'dlmt','fa-angle-right', $cur_color, $storeid),
            )
        );
