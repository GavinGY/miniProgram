...
$wx = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time."  and state  in (4,6,9) and is_yue=2 and type=1 and pay_time !=''";
$wx = pdo_fetch($wx);//今天的微信外卖销售额
$yue = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time."  and state  in (4,6,9) and is_yue=1 and type=1 and pay_time !=''";
$yue = pdo_fetch($yue);//今天的余额外卖销售额
$jf = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time."  and state  in (4,6,9) and is_yue=3 and type=1 and pay_time !=''";
$jf = pdo_fetch($jf);//今天的积分外卖销售额

$ztwx = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time2."  and state  in (4,6,9) and is_yue=2 and type=1 and pay_time !=''";
$ztwx = pdo_fetch($ztwx);//昨天的微信外卖销售额
$ztyue = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time2."  and state  in (4,6,9) and is_yue=1 and type=1 and pay_time !=''";
$ztyue = pdo_fetch($ztyue);//昨天的余额外卖销售额
$ztjf = "select sum(money) as total from " . tablename("wpdc_order")." WHERE time LIKE ".$time2."  and state  in (4,6,9) and is_yue=3 and type=1 and pay_time !=''";
