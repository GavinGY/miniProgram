  ...
  getCalculationInfo: function(){
    ...
    app.sendRequest({
      ...
      success: function(res){
        ...
        if (app.globalData.takeoutAddressSelected) {
        ...
        _this.setData({
          disablePay:info.is_take_deliver,
          ...
          express_fee: info.deliver_fee,
          discount_cut_price: info.discount_cut_price,
          balance: info.balance,
          deduction: info.use_balance,
          original_price: info.original_price,
          totalPayment: info.price,
          takeoutShopName: _this.takeoutShopInfo.title,
          takeoutShopImg: _this.takeoutShopInfo.cover,
