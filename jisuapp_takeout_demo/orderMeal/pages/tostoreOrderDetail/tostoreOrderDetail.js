...
Page({
  ...
  paySuccessCallback: function(){
    ...
    let pagePath = '/orderMeal/pages/paySuccess/paySuccess?detail=' + orderId 
  ...
  makeComment: function () {
    var franchiseeId = this.data.franchiseeId,
      pagePath = '/orderMeal/pages/makeTostoreComment/makeTostoreComment?detail=' + this.data.orderInfo.order_id + (franchiseeId ? '&franchisee=' + franchiseeId : '');
    app.turnToPage(pagePath);
  }
})
