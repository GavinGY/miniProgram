...
Page({
  ...
  onShareAppMessage: function (e) {
    let that = this,
        ...
        url = '/eCommerce/pages/joinGroupDetail/joinGroupDetail?detail=' + goodsInfo.goods_id + '&teamToken=' + teamToken + (franchisee ? '&franchisee=' + franchisee : ''),
    ...
    return appInstance.shareAppMessage({ 
      title: title,
      path: url,
      imageUrl: 'https://test2.zhichiwangluo.com/zhichi_frontend/static/webapp/images/group_goods_share.jpeg',
