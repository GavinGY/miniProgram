...
Page({
    ...
    app.getOrderDetail({
      ...
      success: function (res) {
        ...
        for (let i = 0; i < goodsData.length;i++){
          goodsData[i].preview_refund_num = goodsData[i].num - goodsData[i].refunded_num;
  ...
  clickPlusButton: function(e){
    let index = e.currentTarget.dataset.index;
    let previewRefundNum = this.data.goodsList[index].preview_refund_num;
    let maxRefundNum = this.data.goodsList[index].num - this.data.goodsList[index].refunded_num;
